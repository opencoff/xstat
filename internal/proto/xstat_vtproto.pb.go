...
func (m *Xstat) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *Xstat) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *Xstat) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.Ino != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Ino))
		i--
		dAtA[i] = 0x48
	}
	if m.Nlink != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Nlink))
		i--
		dAtA[i] = 0x40
	}
	if m.Atime != nil {
		size, err := m.Atime.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.Mtime != nil {
		size, err := m.Mtime.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *Time) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Nsec != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Nsec))
		i--
		dAtA[i] = 0x10
	}
	if m.Sec != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Sec))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Xstat) SizeVT() (n int) {
	...
	if m.Nlink != 0 {
		n += 1 + sov(uint64(m.Nlink))
	}
	if m.Ino != 0 {
		n += 1 + sov(uint64(m.Ino))
	}
	if len(m.Xattr) > 0 {
...
func (m *Time) SizeVT() (n int) {
	...
	_ = l
	if m.Sec != 0 {
		n += 1 + sov(uint64(m.Sec))
	}
	if m.Nsec != 0 {
		n += 1 + sov(uint64(m.Nsec))
	}
	n += len(m.unknownFields)
	return n
}
...
func (m *Xstat) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: Xstat: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Xstat: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 6:
			...
			if err := m.Mtime.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
			...
			if err := m.Atime.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 8:
		...
		case 10:
			...
			if m.Xattr == nil {
				m.Xattr = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
